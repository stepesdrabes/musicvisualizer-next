 ...
 * material as that". The analyser under test currently scores well on the first and throws the
 * answer away before the second, so reporting only a combined figure would hide the whole bug.
 */
 ...
 * failure this analyser actually has, where a single label spans most of the track.
 */
